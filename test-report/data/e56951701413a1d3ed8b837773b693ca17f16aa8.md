...
- Name: Visual Regression - Extrakorporale Stoßwellentherapie Page (Desktop) >> stosswellentherapie-visual-desktop-fr
- Location: /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/ExtrakorporaleStosswellentherapie/ExtrakorporaleStosswellentherapieUITest.spec.ts:34:9
...
Received:    3.252003417524992
    ...
    at /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/ExtrakorporaleStosswellentherapie/ExtrakorporaleStosswellentherapieUITest.spec.ts:35:7
```
  ...
  - navigation:
    ...
    - button "Français":
      - link "Français":
        ...
        - img
        - text: Français
- heading "Traitement efficace des troubles musculo-squelettiques grâce à la thérapie moderne par ondes de choc chez Dolomed" [level=1]:
  - text: Traitement efficace des troubles musculo-squelettiques grâce à la
  - strong: thérapie
  - text: moderne
  - strong: par ondes de choc chez Dolomed
- paragraph: La thérapie extracorporelle par ondes de choc (ESWT) est une méthode innovante et non invasive de traitement des problèmes musculo-squelettiques. Des ondes de choc ciblées permettent de stimuler les processus de guérison, de soulager la douleur et d'améliorer la fonctionnalité des muscles, des tendons et des ligaments. Chez Dolomed, nous utilisons une technologie d'ondes de choc de pointe pour offrir à nos patients une thérapie douce et efficace.
...
- heading "Qu'est-ce que la thérapie extracorporelle par ondes de choc ?" [level=2]
- paragraph: La thérapie par ondes de choc utilise des ondes sonores de haute énergie qui sont appliquées de manière ciblée sur les zones douloureuses ou blessées du corps. Ces ondes stimulent la circulation sanguine, favorisent la régénération des tissus et réduisent l’inflammation. L’ESWT est une forme de thérapie éprouvée pour le traitement d’un grand nombre de troubles de l’appareil locomoteur.
- list:
  - listitem:
    - strong: "Ondes de choc focalisées :"
    - text: Énergie concentrée de haute précision pour le traitement des structures profondes.
  - listitem:
    - strong: "Les ondes de choc radiales :"
    - text: Ondes plus étendues pour traiter des structures tissulaires plus superficielles.
- heading "Possibilités d'utilisation de la thérapie par ondes de choc" [level=2]
- paragraph: "La thérapie par ondes de choc est utilisée avec succès pour traiter différents troubles musculo-squelettiques :"
- list:
  - listitem:
    - strong: "Inflammations des tendons :"
    - text: Traitement des tendinopathies telles que la tendinite d'Achille ou le tennis elbow.
  - listitem:
    - strong: "Douleurs des fascias :"
    - text: soulagement des douleurs dues à des fascias collés ou enflammés.
  - listitem:
    - strong: "Les calcifications :"
    - text: Dissolution des dépôts calcaires, par exemple dans l'épaule (épaule calcaire).
  - listitem:
    - strong: "Points de déclenchement :"
    - text: Traitement des tensions musculaires douloureuses et des nœuds.
  - listitem:
    - strong: "Fasciite plantaire :"
    - text: soulager la douleur au talon en traitant le fascia plantaire.
  - listitem:
    - strong: "les blessures sportives :"
    - text: Aide à la guérison en cas de lésions de surcharge et de blessures chroniques.
- img "IMG_5285-scaled"
- img "Dolomed-Bewegungsapparat-arthrose-circles-4"
- heading "Bases théoriques de la thérapie par ondes de choc" [level=2]
- paragraph: "La thérapie par ondes de choc est basée sur la transmission d'ondes sonores mécaniques dans les tissus, ce qui déclenche une multitude d'effets positifs :"
- list:
  - listitem:
    - strong: "Stimulation de la circulation sanguine :"
    - text: augmente l'apport d'oxygène et de nutriments dans les tissus affectés.
  - listitem:
    - strong: "Stimulation de la régénération cellulaire :"
    - text: active les forces d'autoguérison et favorise la formation de nouveaux tissus.
  - listitem:
    - strong: "Réduction de l'inflammation :"
    - text: Inhibe les processus inflammatoires et atténue ainsi les symptômes de la douleur.
  - listitem:
    - strong: "Dissolution de l'entartrage :"
    - text: Les ondes mécaniques aident à décomposer et à évacuer les dépôts de calcaire.
- heading "Déroulement de la thérapie par ondes de choc chez Dolomed" [level=2]
- paragraph: "Un traitement typique par ondes de choc comprend les étapes suivantes :"
- list:
  - listitem:
    - strong: "1. premier entretien et diagnostic :"
    - text: augmente l'apport d'oxygène et de nutriments dans les tissus concernés.
  - listitem:
    - strong: "2. planification de la thérapie :"
    - text: choix de la thérapie par ondes de choc appropriée (focalisée ou radiale) en fonction du diagnostic.
  - listitem:
    - strong: "3. réalisation du traitement :"
    - text: application des ondes de choc directement sur la région douloureuse. Une séance dure généralement de 10 à 20 minutes.
  - listitem:
    - strong: "4. suivi :"
    - text: surveillance de la guérison et adaptation du plan de traitement si nécessaire.
- img "Dolomed-Bewegungsapparat-arthrose-circles-4"
- heading "Avantages de la thérapie par ondes de choc" [level=2]
- paragraph: "La thérapie par ondes de choc offre de nombreux avantages aux patients souffrant de troubles musculo-squelettiques :"
- list:
  - listitem:
    - strong: "Non-invasif :"
    - text: pas d'opération, pas de cicatrice.
  - listitem:
    - strong: "Indolore :"
    - text: la plupart des patients trouvent le traitement agréable ou seulement légèrement désagréable.
  - listitem:
    - strong: "Des résultats rapides :"
    - text: De nombreux patients font état d'une nette amélioration après quelques séances seulement.
  - listitem:
    - strong: "Large éventail d'applications :"
    - text: efficace pour les affections aiguës et chroniques.
  - listitem:
    - strong: "Basé sur des données scientifiques :"
    - text: De nombreuses études prouvent l'efficacité de la thérapie par ondes de choc.
- heading "Comment continuer ?" [level=2]
- text: Vous souffrez de troubles musculo-squelettiques ? La thérapie extracorporelle par ondes de choc chez Dolomed peut vous aider à soulager la douleur et à retrouver votre mobilité. Contactez-nous dès aujourd’hui à l’adresse
- link "info@dolomed.ch":
  - /url: mailto:info@dolomed.ch
- text: pour prendre rendez-vous et en savoir plus sur les avantages de cette méthode de traitement innovante.
- link "Prendre un rendez-vous":
  - /url: "#"
- heading "Foire aux questions (FAQ)" [level=2]
- button "La thérapie par ondes de choc est-elle douloureuse ?" [expanded]
- region "La thérapie par ondes de choc est-elle douloureuse ?":
  - paragraph: Le traitement est généralement bien toléré. Certains patients ressentent une légère pression pendant l’application.
- button "Combien de temps dure une session ?"
- button "Combien de séances sont nécessaires ?"
- button "Y a-t-il des effets secondaires ?"
- button "Pour quels troubles la thérapie par ondes de choc est-elle indiquée ?"
- button "La thérapie par ondes de choc est-elle prise en charge par l'assurance maladie ?"
- button "Quelle est la rapidité d'action de la thérapie par ondes de choc ?"
- text: Avec la thérapie extracorporelle par ondes de choc chez Dolomed, nous vous proposons une solution efficace et moderne à vos problèmes. Travaillons ensemble pour améliorer durablement votre qualité de vie. Prenez rendez-vous dès maintenant !
