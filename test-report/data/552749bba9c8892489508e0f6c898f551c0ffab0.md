...
- Name: Visual Regression - Nervenstimulation Page (Desktop) >> nervenstimulation-visual-desktop-de
- Location: /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/Nervenstimulation/NervenstimulationPageUITest.spec.ts:34:9
...
Received:    3.6764554738203823
    ...
    at /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/Nervenstimulation/NervenstimulationPageUITest.spec.ts:35:7
```
...
- paragraph: Nervenstimulation ist eine bewährte Methode zur Schmerzlinderung und Muskelstimulation, die sowohl bei akuten als auch bei chronischen Schmerzen eingesetzt werden kann. Bei Dolomed bieten wir verschiedene Formen der Nervenstimulation an, darunter TENS (Transkutane Elektrische Nervenstimulation), periphere Neurostimulation und zentrale Neurostimulation. Erfahren Sie mehr über diese innovativen Therapiemöglichkeiten und wie sie Ihnen helfen können, Ihre Lebensqualität zu verbessern.
...
- paragraph: Nervenstimulation, auch bekannt als Elektrostimulation, nutzt elektrische Impulse zur Stimulierung von Nerven und Muskeln. Diese Impulse können Schmerzen lindern, die Heilung fördern und die Muskelstärke verbessern. Die einfachste Form der Elektrostimulation, die transkutane Elektrostimulation (TENS) wird häufig in der Physiotherapie und Rehabilitation eingesetzt und hat sich als wirksame Therapie bei verschiedenen Schmerzarten und Muskelproblemen erwiesen. Eine weiterführende Therapie sind die periphere und zentrale Elektrostimulation, wo Elektroden implantiert werden, die eine Modulation des Schmerzsignals erreichen.
- heading "TENS Geräte (Transkutane Elektrische Nervenstimulation)" [level=2]
- paragraph: TENS, gelegentlich auch Elektrotherapie oder Elektrostimulation genannt, ist eine nicht-invasive Methode der Nervenstimulation, bei der kleine elektrische Impulse durch die Haut an die Nerven gesendet werden. Dies kann helfen, Schmerzen zu blockieren und die Freisetzung von Endorphinen zu fördern, die als natürliche Schmerzmittel des Körpers wirken.
- heading "Vorteile der TENS-Therapie:" [level=3]
- list:
  - listitem: Schmerzlinderung bei akuten und chronischen Schmerzen
  - listitem: Verbesserung der Durchblutung und Förderung der Heilung
  - listitem: Anwendung zu Hause mit tragbaren TENS-Geräten möglich
- img "Dolomed-Nervenstimulation-Periphere-Illustrator-04-1"
- img "Dolomed-Bewegungsapparat-arthrose-circles-4"
- heading "Periphere Neurostimulation" [level=2]
- paragraph: Die periphere Neurostimulation zielt auf spezifische Nerven außerhalb des Gehirns und Rückenmarks ab, um Schmerzen zu lindern und die Funktion der betroffenen Muskeln zu verbessern. Diese Behandlung wird häufig bei Schmerzen nach Verletzungen oder Operationen eingesetzt.
...
- list:
  ...
  - listitem: Minimale Nebenwirkungen im Vergleich zu medikamentösen Therapien
- heading "Zentrale Neurostimulation" [level=2]
- paragraph: Die zentrale Neurostimulation, auch als Spinal Cord Stimulation (SCS) bekannt, zielt auf das Rückenmark ab, um chronische Schmerzen zu lindern. Diese Methode ist besonders wirksam bei Patienten, die auf herkömmliche Schmerzbehandlungen nicht ansprechen. Bei der zentralen Neurostimulation werden in einer kleinen Operation 2 Elektroden in den Wirbelkanal implantiert. Die Modulation der Schmerzsignale führt dann zu einer verminderten Empfindung der Schmerzen, ohne die sonstigen Funktionen des Nervensystems zu beeinflussen. Dieser sogenannte "Schmerzschrittmacher" eignet sich vor allem für Patienten, die bereits am Rücken operiert wurden, für Diabetiker (diabetische Polyneuropathie) und für Patienten mit eingeschränkter Durchblutung (pAVK).
...
- list:
  ...
  - listitem: Verbesserung der Lebensqualität bei schwer behandelbaren Schmerzen
...
- region "Was ist der Unterschied zwischen TENS und EMS?": TENS (Transkutane Elektrische Nervenstimulation) wird hauptsächlich zur Schmerzlinderung eingesetzt, während EMS (Elektrische Muskelstimulation) darauf abzielt, die Muskeln zu stärken und zu rehabilitieren.
- button "Ist Elektrostimulation gesund?"
- button "Wie effektiv ist EMS-Training wirklich?"
- button "Was sagen Ärzte zu EMS-Training?"
- button "Für wen ist EMS nicht geeignet?"
