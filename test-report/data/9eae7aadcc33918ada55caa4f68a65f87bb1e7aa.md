...
- Name: Visual Regression - PRP Page (Desktop) >> prp-visual-desktop-fr
  ...
  - navigation:
    ...
    - button "Français":
      - link "Français":
        ...
        - img
        - text: Français
- 'heading "Stimulation de l''autoguérison grâce à l''autohémothérapie : Platelet Rich Plasma (PRP) pour un traitement efficace (possible pendant le sommeil)" [level=1]':
  - text: "Stimulation de l'autoguérison grâce à l'autohémothérapie : Platelet Rich"
  - strong: Plasma (PRP) pour un traitement efficace (possible pendant le sommeil)
- paragraph: Le plasma riche en plaquettes (PRP) est une thérapie innovante qui utilise les processus de guérison de l'organisme pour traiter différentes maladies et blessures. Chez Dolomed, nous proposons le PRP dans le cadre de notre offre thérapeutique complète afin de favoriser la guérison et d'améliorer la qualité de vie de nos patients.
...
- heading "Qu'est-ce que le plasma riche en plaquettes (PRP) ?" [level=2]
- paragraph: Le PRP, également connu sous le nom d'autohémothérapie, utilise le propre sang du patient pour concentrer des facteurs de croissance favorisant la guérison et les injecter dans les zones concernées. Cela favorise l'auto-guérison et accélère le processus de guérison de différents troubles. La régénération nécessite non seulement des cellules existantes qui produisent des matériaux de construction tels que le collagène, mais aussi des facteurs de croissance qui servent de signaux. Ces derniers sont concentrés dans le cadre de l'autohémothérapie afin de déclencher la guérison.
- heading "Possibilités d'utilisation du traitement PRP/de l'autotransfusion" [level=2]
- paragraph: "La thérapie PRP peut théoriquement être utilisée dans tous les domaines, c'est pourquoi la liste suivante n'est qu'une aide à l'orientation. D'autres utilisations, comme les lombalgies chroniques ou les douleurs post-opératoires, sont tout aussi possibles :"
- list:
  - listitem:
    - strong: "Orthopédie et traumatologie :"
    - text: traitement des blessures articulaires et ligamentaires, en particulier pour les blessures du genou, de l'épaule et de la cheville.
  - listitem:
    - strong: "Arthrose :"
    - text: soulager les symptômes et favoriser la régénération en cas d'arthrose articulaire.
  - listitem:
    - strong: "Blessures sportives :"
    - text: Accélérer la guérison des blessures musculaires, tendineuses et ligamentaires.
  - listitem:
    - strong: "Dermatologie :"
    - text: traitement des maladies de la peau telles que la dermatite atopique et promotion de la cicatrisation.
- img "Dolomed-Bewegungsapparat-arthrose-circles-4"
- heading "Déroulement de la thérapie PRP" [level=2]
- paragraph: "Une thérapie PRP chez Dolomed comprend plusieurs étapes afin de s'assurer que le traitement est sûr et efficace :"
- list:
  - listitem:
    - strong: "Prélèvement sanguin :"
    - text: une petite quantité de sang (environ 15 ml) est prélevée dans la veine du patient.
  - listitem:
    - strong: "Préparation :"
    - text: le sang est préparé pendant 5 minutes dans une centrifugeuse afin d'obtenir le plasma riche en plaquettes.
  - listitem:
    - strong: "Injection :"
    - text: le PRP est injecté dans la zone affectée afin de favoriser la guérison. Le plus souvent, cette opération est réalisée avec précision sous contrôle échographique.
  - listitem:
    - strong: "Répétition :"
    - text: le traitement doit être effectué au moins 3 fois, à une semaine d'intervalle.
  - listitem:
    - strong: "Suivi :"
    - text: rendez-vous de contrôle réguliers pour surveiller le processus de guérison.
- heading "Avantages de la thérapie PRP" [level=2]
- paragraph: "La thérapie PRP présente de nombreux avantages pour les patients souffrant de divers troubles :"
- list:
  - listitem:
    - strong: "Guérison naturelle :"
    - text: utilisation de substances propres au corps pour favoriser la guérison.
  - listitem:
    - strong: "Les effets secondaires sont minimes :"
    - text: Comme il s'agit de sang autologue, les effets secondaires sont rares.
  - listitem:
    - strong: "Utilisation polyvalente :"
    - text: efficace pour une grande variété de blessures et de maladies.
...
- button "L'autohémothérapie est-elle remboursée par l'assurance maladie ?" [expanded]
- region "L'autohémothérapie est-elle remboursée par l'assurance maladie ?":
  - paragraph: La prise en charge par les caisses d’assurance maladie obligatoires varie. Demandez à votre médecin, il pourra vous aider à ce sujet.
- button "Qui peut pratiquer l'autohémothérapie ?"
- button "Quelle est la durée de vie du sang autologue ?"
- button "Comment se déroule une autohémothérapie ?"
- button "Quels sont les effets secondaires de l'autohémothérapie ?"
- button "Quelles sont les applications du PRP ?"
- button "Combien de temps faut-il pour que les effets de la thérapie PRP se fassent sentir ?"
- button "Quels sont les avantages de la thérapie PRP par rapport aux méthodes de traitement traditionnelles ?"
