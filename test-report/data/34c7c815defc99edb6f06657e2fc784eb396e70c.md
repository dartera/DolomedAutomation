...
- Name: Visual Regression - Gefaesserkrankungen Page (Mobile) >> gefaesserkrankungen-visual-mobile-fr
- Location: /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/gefaesserkrankungen/GefaesserkrankungenUITest.spec.ts:64:9
...
Received:    9.500729332017675
    ...
    at /Users/b.enukidze/Documents/Dartera/Test/DolomedAutomation/src/tests/gefaesserkrankungen/GefaesserkrankungenUITest.spec.ts:65:7
```
  ...
  - navigation:
    ...
    - button "Français":
      - link "Français":
        ...
        - img
        - text: Français
- heading "Douleurs liées aux maladies vasculaires" [level=1]:
  - text: Douleurs liées
  - strong: aux maladies vasculaires
- 'heading "Approches thérapeutiques complètes de la douleur liée aux maladies vasculaires : Des options de traitement efficaces chez Dolomed" [level=2]'
- paragraph: Les douleurs liées aux maladies vasculaires peuvent avoir un impact considérable sur la qualité de vie et sont souvent difficiles à traiter. Chez Dolomed, nous proposons un large éventail d'options thérapeutiques pour soulager ces douleurs et améliorer la santé de nos patients. Nos approches globales incluent des techniques de pointe telles que le TENS, les perfusions de kétamine, les infiltrations et la neurostimulation.
...
- heading "Que sont les douleurs liées aux maladies vasculaires ?" [level=2]
- paragraph: Les douleurs liées aux maladies vasculaires sont dues à une diminution de la circulation sanguine en raison d'un rétrécissement ou d'une obstruction des vaisseaux sanguins. Cela peut entraîner une variété de symptômes, y compris la douleur, l'engourdissement et la faiblesse dans les zones touchées.
- heading "Maladie artérielle périphérique (MAP)" [level=2]
- paragraph: La maladie artérielle périphérique est une maladie chronique dans laquelle les artères qui alimentent les membres en sang sont rétrécies ou bloquées. Cela provoque des douleurs, notamment à la marche, et peut entraîner des douleurs au repos et une perte de tissus à un stade avancé. Souvent, les patients sont déjà pris en charge par des collègues angiologues ou chirurgiens vasculaires. Dolomed peut être un soutien supplémentaire.
- heading "Options thérapeutiques pour Dolomed :" [level=3]
- list:
  - listitem:
    - strong: "Perfusion de kétamine :"
    - text: Soulagement efficace de la douleur dans les cas réfractaires.
  - listitem:
    - strong: "Neurostimulation :"
    - text: stimulation des nerfs afin de bloquer les signaux de douleur et de favoriser la guérison. La microcirculation peut également être améliorée par la neurostimulation centrale.
  - listitem:
...
- paragraph: L'angine de poitrine est un symptôme de la maladie coronarienne qui se caractérise par une douleur ou une pression dans la poitrine due à une diminution de la circulation sanguine dans le muscle cardiaque. L'angine de poitrine aiguë constitue une urgence en tant que signe d'un infarctus aigu du myocarde, c'est pourquoi il convient dans ce cas d'appeler le service d'ambulance.
- heading "Options thérapeutiques pour Dolomed :" [level=3]
- list:
  - listitem:
    - strong: "Neurostimulation :"
    - text: blocage des signaux de douleur et amélioration de la circulation sanguine.
