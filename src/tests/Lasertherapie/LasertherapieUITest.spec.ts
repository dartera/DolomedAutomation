...
// Define language configs for the Lasertherapie page
const lasertherapieLanguages = [
  {
    url: '/lasertherapie/',
    code: 'de',
    name: 'German (Default)',
...
test.describe('Visual Regression - Lasertherapie Page (Desktop)', () => {
  ...
  for (const lang of lasertherapieLanguages) {
    test(`lasertherapie-visual-desktop-${lang.code}`, async () => {
      await visualHelper.runIndividualLanguageTest(
        lang,
        'lasertherapie-visual',
        {
...
test.describe('Visual Regression - Lasertherapie Page (Mobile)', () => {
  let visualHelper: MultiLanguageVisualHelper;
  ...
  for (const lang of lasertherapieLanguages) {
    test(`lasertherapie-visual-mobile-${lang.code}`, async () => {
      await visualHelper.runIndividualLanguageTest(
        lang,
        'lasertherapie-visual-mobile',
        {
          diffThreshold: visualTestDefaults.diffThreshold,
          customStyles: `* { max-width: 100% !important; overflow-x: hidden !important; } body { width: 100% !important; margin: 0 !important; padding: 0 !important; overflow-x: hidden !important; }`,
          scrollToBottom: visualTestDefaults.scrollToBottom,
