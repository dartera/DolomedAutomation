...
function getLanguageUrl(lang: string): string {
    // German is served from the base path for akupunktur
    if (lang === 'de') return '/natuerliche-linderung-durch-akupunktur/';
    
    // All other languages use their language code in the URL
    return `/${lang}/natuerliche-linderung-durch-akupunktur/`;
} 